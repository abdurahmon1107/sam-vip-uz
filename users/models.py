...
class User(BaseModel):
    class GenderType(models.Choices):
        MAN = "Erkak", "erkak"
        WOMAN = "Ayol", "ayol"
...
class ProductClearance(BaseModel):  # Mahsulotni rasmiylashtirish

    class CityType(models.Choices):
...
class UserProduct(BaseModel):
    ...
    price = MoneyField(quantity, Product.price)
